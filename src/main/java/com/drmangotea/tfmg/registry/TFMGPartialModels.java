...
public class TFMGPartialModels {
    ...
    public static final PartialModel
            ...
            CAST_IRON_AIR_INTAKE_FRAME = block("cast_iron_air_intake/frame"),
            CAST_IRON_AIR_INTAKE_FRAME_CLOSED = block("cast_iron_air_intake/frame_closed"),
            CAST_IRON_AIR_INTAKE_MEDIUM = block("cast_iron_air_intake/block_medium"),
            CAST_IRON_AIR_INTAKE_LARGE = block("cast_iron_air_intake/block_large"),
