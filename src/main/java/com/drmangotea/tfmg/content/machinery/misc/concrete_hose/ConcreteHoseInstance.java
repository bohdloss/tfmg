...
import com.simibubi.create.content.contraptions.pulley.AbstractPulleyInstance;
import com.simibubi.create.content.fluids.hosePulley.HosePulleyBlockEntity;
import com.simibubi.create.foundation.utility.AnimationTickHolder;

public class ConcreteHoseInstance extends AbstractPulleyInstance<ConcreteHoseBlockEntity> {

	public ConcreteHoseInstance(MaterialManager dispatcher, ConcreteHoseBlockEntity blockEntity) {
