...
public class LithiumFireBlock extends FireBlock implements ICustomFire {
    public static final MapCodec<FireBlock> CODEC = simpleCodec(LithiumFireBlock::new);

    public LithiumFireBlock(Properties properties) {
        super(properties);
    }
