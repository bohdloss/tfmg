...
//    }
    ...
    public static void generateCautionBlocks() {
        for (String color : COLORS) {
            ...
            REGISTRATE.block(color + "_caution_block", CautionBlock::new)
    ...
    public static MaterialSet generateConcrete(boolean rebar) {
        ...
        var block = REGISTRATE.block(name, Block::new)
        ...
        var wall = REGISTRATE.block(name + "_wall", WallBlock::new)
                .initialProperties(() -> Blocks.STONE)
                .properties(p -> p.requiresCorrectToolForDrops())
                .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                .transform(pickaxeOnly())
                ...
                .tag(BlockTags.NEEDS_STONE_TOOL)
                .tag(BlockTags.WALLS)
                .recipe((c, p) -> p.stonecutting(DataIngredient.items(block.get()), RecipeCategory.BUILDING_BLOCKS, c::get, 1))
                .item()
                .transform(b -> TFMGVanillaBlockStates.transformWallItem(b, "concrete"))
                .build()
                .register();

        var stairs = REGISTRATE.block(name + "_stairs", p -> new StairBlock(block.get().defaultBlockState(), p))
                .initialProperties(() -> Blocks.STONE)
                .properties(p -> p.requiresCorrectToolForDrops())
                .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                .transform(pickaxeOnly())
        ...
        var slab = REGISTRATE.block(name + "_slab", SlabBlock::new)
                .initialProperties(() -> Blocks.STONE)
                .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                .properties(p -> p.requiresCorrectToolForDrops())
                .transform(pickaxeOnly())
                ...
                .tag(BlockTags.NEEDS_STONE_TOOL)
                .tag(BlockTags.SLABS)
                .recipe((c, p) -> p.stonecutting(DataIngredient.items(block.get()), RecipeCategory.BUILDING_BLOCKS, c::get, 2))
                .item()
                .transform(customItemModel("concrete_bottom"))
                .register();

        return new MaterialSet(block, slab, stairs, wall);
    }
    ...
    public static Map<String ,MaterialSet> generateColoredConcrete(boolean rebar) {
        ...
        for (String color : COLORS) {
            var block = REGISTRATE.block(color + name, Block::new)
                    .initialProperties(() -> Blocks.STONE)
                    .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                    .properties(p -> p.requiresCorrectToolForDrops())
                    .transform(pickaxeOnly())
            ...
            var wall = REGISTRATE.block(color + name + "_wall", WallBlock::new)
                    .initialProperties(() -> Blocks.STONE)
                    .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                    .properties(p -> p.requiresCorrectToolForDrops())
                    .transform(pickaxeOnly())
                    ...
                    .tag(BlockTags.NEEDS_STONE_TOOL)
                    .tag(BlockTags.WALLS)
                    .recipe((c, p) -> p.stonecutting(DataIngredient.items(block.asItem()), RecipeCategory.BUILDING_BLOCKS, c::get, 1))
                    .item()
                    .transform(b -> TFMGVanillaBlockStates.transformWallItem(b, color + "_concrete"))
                    .build()
                    .register();

            var stairs = REGISTRATE.block(color + name + "_stairs", p -> new StairBlock(TFMGBlocks.CONCRETE.block().getDefaultState(), p))
                    .initialProperties(() -> Blocks.STONE)
                    .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                    .properties(p -> p.requiresCorrectToolForDrops())
                    .transform(pickaxeOnly())
            ...
            var slab = REGISTRATE.block(color + name + "_slab", SlabBlock::new)
                    .initialProperties(() -> Blocks.STONE)
                    .properties(p -> p.strength(rebar ? 12f : 3.5f, rebar ? 1200f : 3.5f))
                    .properties(p -> p.requiresCorrectToolForDrops())
                    .transform(pickaxeOnly())
                    ...
                    .tag(BlockTags.NEEDS_STONE_TOOL)
                    .tag(BlockTags.SLABS)
                    .recipe((c, p) -> p.stonecutting(DataIngredient.items(block.asItem()), RecipeCategory.BUILDING_BLOCKS, c::get, 2))
                    .item()
                    .transform(customItemModel(color + "_concrete_bottom"))
                    .register();

            list.put(color, new MaterialSet(block, slab, stairs, wall));
        }
    ...
    public static MaterialSet makeVariants(BlockEntry<?> blockEntry, boolean recipe) {
        ...
        var slab = REGISTRATE.block(name + "_slab", SlabBlock::new)
                ...
                .register();
        var stairs = REGISTRATE.block(name + "_stairs", p -> new StairBlock(TFMGBlocks.CONCRETE.block().getDefaultState(), p))
                .initialProperties(() -> Blocks.STONE)
                .transform(pickaxeOnly())
        ...
        return new MaterialSet(blockEntry, slab, stairs, wall);
    }
}
